...
| AV-03 | Broken auth — JWT forgery              | Hardcoded `***REMOVED***` enables token forgery |
...
| AV-07 | Hardcoded JWT secret                   | `***REMOVED*** = '***REMOVED***'` fallback |
...
| FV-03 | Session hijacking                      | `***REMOVED***='***REMOVED***'` in docker-compose.yml |
...
| ID    | Vulnerability                          | Location |
|-------|----------------------------------------|----------|
| IV-01 | Hardcoded DB password                  | `docker-compose.yml` ***REMOVED*** |
| IV-02 | Database exposed on host network       | `docker-compose.yml` ports 5432 and 5433 |
| IV-03 | Secrets in environment variables       | `docker-compose.yml` ***REMOVED***, ***REMOVED***, ***REMOVED*** |
...
| CK-03 | Unpinned image tags                    | `docker-compose.yml` and K8s base use `***REMOVED***:14`, `:latest` |
