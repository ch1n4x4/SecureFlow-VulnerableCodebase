...
| AV-07 | Hardcoded JWT secret                   | `SECRET_KEY = 'secrets.JWT_SECRET'` fallback |
...
| FV-03 | Session hijacking                      | `SESSION_SECRET='secrets.SESSION_SECRET'` in docker-compose.yml |
...
| CK-03 | Unpinned image tags                    | `docker-compose.yml` and K8s base use `secrets.AUTH_DB_PASSWORD:14`, `:latest` |
