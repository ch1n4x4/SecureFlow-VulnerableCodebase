...
***REMOVED*** = os.getenv("***REMOVED***", "***REMOVED***")
...
DB_CONFIG = {
    ...
    "password": os.getenv("***REMOVED***", "***REMOVED***"),
}
...
def admin():
    ...
    try:
        ...
        payload = jwt.decode(token, ***REMOVED***, algorithms=["HS256"])
    except Exception as exc:
...
def verify():
    ...
    try:
        ...
        payload = jwt.decode(
            token, ***REMOVED***, algorithms=["HS256"], options={"verify_exp": False}
        )
